    ...
    <div class="container">
      ...
      <div class="comparison-table">
        ...
        >
          ...
          <el-table-column v-for="(tariff, index) in tariffs" :key="index" :label="tariff.title">
            <template #default="{ row }">
        ...
        <div class="table-footer">
          <el-button 
            ...
            :key="tariff.id"
            :type="tariff.id === 'premium' ? 'primary' : ''"
            class="order-btn"
            @click="scrollToForm(tariff.id)"
          >
            Заказать {{ tariff.title }}
          </el-button>
        </div>
      </div>
    </div>
