    ...
    <div class="container">
      ...
      >
        ...
        <el-sub-menu index="/services">
          <template #title @click="scrollToBrief">Услуги</template>
          ...
          <el-menu-item index="/services/smm">Точно-в-цель Аудит</el-menu-item>
          <el-menu-item index="/services/smm">Маркетинг под ключ</el-menu-item>
        </el-sub-menu>
